...
int main(int argc, char * argv[]) {
	...
	deep.dataset_upload_test("test1.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test2.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test3.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test4.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test5.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test6.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test7.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test8.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test9.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test10.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test11.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test12.log",5489);
	deep.test_datas();
	deep.dataset_upload_test("test13.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test14.log",2464);
	deep.test_datas();
	deep.dataset_upload_test("test15.log",2464);
	deep.test_datas();
